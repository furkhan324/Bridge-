...
public class Add4 extends FragmentActivity {
    ...
    setContentView(R.layout.add_event);
        ...
        TextView join= (TextView) findViewById(R.id.enterevent);
        EditText location= (EditText) findViewById(R.id.location);

        Typeface lb= Typeface.createFromAsset(getAssets(), "fonts/lb.ttf");
        Typeface ll= Typeface.createFromAsset(getAssets(), "fonts/lr.ttf");
